...
function CommentCard({ comment }: { comment: Comment }) {
  ...
  return (
    <div
      className="grid max-w-[730px] grid-cols-2 grid-rows-[auto_1fr_auto] gap-4 rounded-[8px] bg-white p-4 font-normal sm:grid-cols-[auto_1fr_auto] sm:grid-rows-[auto_1fr] sm:gap-x-6 sm:p-6 [&:not(:first-of-type)]:mt-4"
